                ...
                .then(preguntas => {
                    preguntas.sort(() => { return Math.random() - 0.5 }).forEach(p => {
                        ...
                        <div class= "contenedor-inputs">
                            <label class="labels" style=""> <input class="inputsTexts" required type= "radio" name="${cont}" value="${p.respuestas[0]}"> ${p.respuestas[0]}</label>
                            <label class="labels" style=""> <input class="class="inputsTexts"" required type= "radio" name="${cont}" value="${p.respuestas[1]}"> ${p.respuestas[1]}</label>
                            <label class="labels" style=""> <input class="inputsTexts" required type= "radio" name="${cont}" value="${p.respuestas[2]}"> ${p.respuestas[2]}</label>
                        </div>
                    </div>`;
